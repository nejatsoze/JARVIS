...
.mat-tab-labels:has(.pin-tabs) > .mat-tab-label-active:hover{background:var(--gt-strong, #3a404a) !important; color:#fff !important}
...
active-queued-optedin-bonus{display:block; box-sizing:border-box; margin:10px 0; padding:14px 16px 6px; background:#fff;
  border:1px solid #e4e7ec; border-radius:14px; box-shadow:0 1px 2px rgba(16,24,40,.04); font-family:var(--gt-font); color:var(--gt-text, #2c3139)}
active-queued-optedin-bonus .active-bonus-title{display:block; margin-bottom:10px; font-size:14px; font-weight:600; letter-spacing:-.1px; color:var(--gt-text, #2c3139)}
active-queued-optedin-bonus table.player-active-bonuses-table{width:100%; border-collapse:collapse; font-size:12.5px; color:var(--gt-text, #2c3139)}
...
active-queued-optedin-bonus tbody td{padding:9px 10px !important; border:0; border-bottom:1px solid #f2f3f5; vertical-align:middle;
  color:var(--gt-text, #2c3139); font-variant-numeric:tabular-nums; white-space:nowrap}
...
active-queued-optedin-bonus .more-link{color:var(--gt-text, #2c3139) !important; font-weight:600; cursor:help}
...
#gt-lookup .lastbonus{display:inline-flex; align-items:center; gap:7px; box-sizing:border-box; height:28px; padding:0 11px;
  ...
  font-family:var(--gt-font); font-size:12.5px; font-weight:600; color:var(--gt-text, #2c3139); white-space:nowrap; cursor:pointer;
...
#gt-lookup .lb-n{font-size:11px; font-weight:500; color:var(--gt-text, #2c3139); font-variant-numeric:tabular-nums;
...
#gt-cmt{position:absolute; bottom:calc(100% + 10px); height:74px; box-sizing:border-box; padding:9px 14px;
  ...
  font-family:var(--gt-font); color:var(--gt-text, #2c3139); cursor:pointer; user-select:none; overflow:hidden; text-align:left}
